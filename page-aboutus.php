          ...
          <li class="about-rapsodo-item">
            ...
            <div class="about-rapsodo-item-contents">
              ...
              <div class="about-rapsodo-item-contents-text">
                ...
                当施設では、このデータをもとにした個別指導を実施。感覚に頼らず、理論に基づいた練習で、あなたの打撃力を次のレベルへ引き上げます。
                  <!-- Rapsodo Hittingを使い、打球速度や角度、飛距離、回転数などを計測。データをもとに打撃の課題を見える化し、効率的なスイング改良をサポートします。科学的なアプローチで理想の打撃を目指しましょう。 -->
                </p>
              </div>
            </div>
          </li>
